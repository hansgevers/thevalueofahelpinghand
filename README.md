...
Note: For the Stereotype Ordered regressions, margins are referred to in the paper which are based on an interaction effect that is possibly not significant. Across years the interaction effect is 3 to 4 times significant per imputed dataset.
